...
Public Class FrmSumaUnaCifra
    ...
    Private Sub FrmSumaUnaCifra_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Else
            ...
            Else
                ...
                Try
                    ...
                    datosDeErrores("SUMA DE UNA CIFRA", pCifra & " + " & sCifra, txtRespuestaUno.Text)
                Catch ex As Exception
                    MsgBox("No posee audio")
                End Try
    ...
    Private Sub FrmSumaUnaCifra_Closing(sender As Object, e As CancelEventArgs) Handles Me.Closing
        AxmpNumero.Ctlcontrols.stop()
    End Sub
End Class